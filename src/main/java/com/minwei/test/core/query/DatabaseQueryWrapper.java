package com.minwei.test.core.query;

import com.minwei.test.anno.NotionProperty;
import com.minwei.test.constants.FilterType;
import com.minwei.test.function.SFunction;
import com.minwei.test.service.PageService;
...
public class DatabaseQueryWrapper<T> {
    ...
    public DatabaseQueryWrapper<T> andEq(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.EQUAL);
    ...
    public DatabaseQueryWrapper<T> andNotEq(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.NOT_EQUAL);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andContains(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.CONTAINS);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andNotContains(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.NOT_CONTAINS);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andStartsWith(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.STARTS_WITH);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andEndsWith(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.ENDS_WITH);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andIsEmpty(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.IS_EMPTY);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andIsNotEmpty(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.IS_NOT_EMPTY);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andGreaterThan(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.GREATER_THAN);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andLessThan(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.LESS_THAN);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andGreaterThanOrEqualTo(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.GREATER_THAN_OR_EQUAL_TO);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andLessThanOrEqualTo(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.LESS_THAN_OR_EQUAL_TO);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andBefore(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.BEFORE);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andAfter(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.AFTER);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andOnOrBefore(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.ON_OR_BEFORE);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andOnOrAfter(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.ON_OR_AFTER);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andPastWeek(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.PAST_WEEK);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andPastMonth(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.PAST_MONTH);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andPastYear(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.PAST_YEAR);
        andFilter.add(propertyFilter);
        return this;
    }
    ...
    public DatabaseQueryWrapper<T> andNextWeek(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.NEXT_WEEK);
        andFilter.add(propertyFilter);
        return this;
    }

    public DatabaseQueryWrapper<T> orNextMonth(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.NEXT_MONTH);
        orFilter.add(propertyFilter);
        return this;
    }

    public DatabaseQueryWrapper<T> andNextYear(SFunction<T, ?> queryField, Object value) {
        PropertyFilter propertyFilter = buildFilterCommon(queryField, value, FilterType.NEXT_YEAR);
        andFilter.add(propertyFilter);
        return this;
    }
...
//        return NotionUtil.buildFilterByPropertyType(name, type, filterType, value);
    ...
    public List<PageVo> query(String token,String databaseId) {
        ...
        while (true) {
            ...
            QueryResults queryResults = client.queryDatabase(databaseId, compoundFilter, querySorts, startCursor, 100);
            ...
            List<PageVo> pageVos = queryResults.getResults().stream().map(page -> {
                ...
                return pageService.selectById(id, token);
    ...
    public List<String> queryId(String token,String databaseId) {
        // 将构建的相关Filter设置到CompoundFilter中
        compoundFilter.setAnd(andFilter);
        compoundFilter.setOr(orFilter);
    ...
    public List<String> queryAndSave(T object,String token,String databaseId) {
        // 将构建的相关Filter设置到CompoundFilter中
        compoundFilter.setAnd(andFilter);
        compoundFilter.setOr(orFilter);
        ...
        while (true) {
            ...
            if (pageIds.isEmpty()) {
                // 数据不存在,新增
                PageService pageService = NotionUtil.getPageService();
                String pageId = pageService.createPage(object,token, databaseId);
